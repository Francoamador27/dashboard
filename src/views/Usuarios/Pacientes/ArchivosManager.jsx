...
import ArchivosForm from './componentes/ArchivosForm';
import ArchivosList from './componentes/ArchivosList';

// Reemplaza estos por tus componentes reales
const CrearServicio = () => <div className="text-slate-700"><ArchivosForm /></div>;
const ListaServicios = () => <div className="text-slate-700"><ArchivosList /></div>;

const ArchivosManager = () => {
  const [active, setActive] = useState(0);

  const tabs = useMemo(
    () => [
      { key: "crear", label: "Subir Archivo", element: <CrearServicio /> },
      { key: "servicios", label: "Archivos", element: <ListaServicios /> },
    ],
    []
  );
