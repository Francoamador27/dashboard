...
export function usePlantillasAll(filters = {}) {
  ...
  return useQuery({
    ...
    queryFn: () =>
      api.get("/api/plantillas", { params: clean }).then((r) => r.data),
  });
}
...
export function usePlantillas(clienteId, tipo = null) {
  return useQuery({
    ...
    queryFn: () =>
      api
        .get(`/api/clientes/${clienteId}/plantillas`)
        .then((r) =>
...
export function useCrearPlantilla(clienteId) {
  ...
  return useMutation({
    mutationFn: (data) =>
      api
        .post(`/clientes/${clienteId}/plantillas`, toFormData(data), {
...
export function useUpdatePlantilla(clienteId) {
  ...
  return useMutation({
    mutationFn: ({ id, ...data }) =>
      api
        .patch(`/clientes/${clienteId}/plantillas/${id}`, data)
        .then((r) => r.data),
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["plantillas", clienteId] }),
  });
...
export function useConfirmarPlantilla(clienteId) {
  ...
  return useMutation({
    mutationFn: (plantillaId) =>
      api
        .post(`/clientes/${clienteId}/plantillas/${plantillaId}/confirmar`)
        .then((r) => r.data),
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["plantillas", clienteId] }),
  });
...
export function useAgregarLogo(clienteId) {
  ...
  return useMutation({
    mutationFn: ({ plantillaId, ...data }) =>
      api
        .post(
          `/clientes/${clienteId}/plantillas/${plantillaId}/agregar-logo`,
          data,
        )
        .then((r) => r.data),
    onSuccess: () =>
...
export function usePlantillaStatus(clienteId, plantillaId, enabled = false) {
  ...
  return useQuery({
    ...
    queryFn: () =>
      api
        .get(`/clientes/${clienteId}/plantillas/${plantillaId}/status`)
        .then((r) => r.data),
